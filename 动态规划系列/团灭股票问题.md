...
> k 买的时候减1，卖不算， k次交易（k次买-然后卖）
> 必选先卖，再买，这样可以避免 买，买，卖这样同时持有多只股票.
...
> 如果 k 为正无穷，那么就可以认为 k 和 k - 1 是一样的, 消去k
...
> dp[i][1]依赖于dp[i-1][0] 如果用一维数组则dp[i-1][0]会被覆盖成新的dp[i][0], 所以需要先存起来temp=dp[i-1][0]=dp_i_0.
...
# Note
感觉原出处可能是https://leetcode.com/problems/best-time-to-buy-and-sell-stock-with-transaction-fee/discuss/108870/most-consistent-ways-of-dealing-with-the-series-of-stock-problems

[我的总结](https://docs.google.com/document/d/171L3RTDeDUFs7GBpzeqrypo5erXu6IgMTRXEjYKmo_E/edit)
