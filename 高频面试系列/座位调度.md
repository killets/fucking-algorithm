...
这是 [LeetCode 第 855 题](https://leetcode.com/problems/exam-room/)，有趣且具有一定技巧性。这种题目并不像动态规划这类算法拼智商，而是看你对常用数据结构的理解和写代码的水平，个人认为值得重视和学习。
...
> 如果seat -1 是当前区间最短的,不取中间,取seat 0
> 如果seat n是当前区间最短的,不取中间,取seat n
> 否则取中间
...
# Note
Todo 这个题 python中没有treeset, discuss中别人是用heap来做,删除就替代成标记这个segement是否valid来实现的,不valid就继续pop.
